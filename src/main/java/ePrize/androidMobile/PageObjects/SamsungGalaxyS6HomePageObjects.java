...
public class SamsungGalaxyS6HomePageObjects extends AppiumUtils {

	AppiumUtils utils = new AppiumUtils();

	public SamsungGalaxyS6HomePageObjects() {
	...
	public SamsungGalaxyS6HomePageObjects switchMobileHomePage() {
		driver.pressKeyCode(AndroidKeyCode.KEYCODE_HOME);
		return this;
	}

	@Step("Switch to the native app")
	public SamsungGalaxyS6HomePageObjects switchNativeApp() {
	...
	public SamsungGalaxyS6HomePageObjects clickMessageAppIcon() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects clickNewMessageIcon() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects enterMobileNumberSendTextMessage(String shortCode)
	...
	public SamsungGalaxyS6HomePageObjects enterTextMessage(String Keyword) throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects clickComposeSubmitBtn() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyReponseInvalidText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyStopReponseInvalidText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyvalidReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyYesReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyValidDobReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyValidStateReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyHelpReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifystopReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifystopAllReponseText() throws InterruptedException {
	...
	public SamsungGalaxyS6HomePageObjects verifyinvalidReponseText() throws InterruptedException {
