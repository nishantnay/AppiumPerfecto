...
public class WindTunnelUtils {
	...
	// WIND_TUNNEL_REPORT_URL_CAPABILITY is deprecated, use
	// SINGLE_TEST_REPORT_URL_CAPABILITY instead
	...
	/**
	 * Adds a timer report to the Wind Tunnel report. Example:
	...
	/**
	 * Example: PersonaProperties properties = new PersonaProperties("Pedro",
	 * "This is Pedro's profile", "PUBLIC:personas/Perdo.jpg"); PersonaDevice
	 * device = new PersonaDevice(); device.setModel("iPhone-5S");
	 * PersonaSettings settings = new PersonaSettings(null, "Boston",
	 * "landscape", "4G LTE Advanced Good", "Waze,YouTube"); String persona =
	 * createWindTunnelPersona(properties, device, settings);
	 */
	public static String createWindTunnelPersona(PersonaProperties properties, PersonaDevice device,
			PersonaSettings settings) throws JsonProcessingException {
	 ...
	 * device = new PersonaDevice(); device.setModel("iPhone-5S");
	 * PersonaSettings settings = new PersonaSettings(null, "Boston",
	 * "landscape", "4G LTE Advanced Good", "Waze,YouTube"); String
	 * repositoryKey = uploadWindTunnelPersona(myHost, myUser, myPassword,
	 * "PRIVATE:Personas", properties, device, settings);
	 * capabilities.setCapability(WindTunnelUtils.WIND_TUNNEL_PERSONA_KEY_CAPABILITY,
	 * repositoryKey);
	 */
	public static String uploadWindTunnelPersona(String host, String user, String password, String repositoryFolder,
			PersonaProperties properties, PersonaDevice device, PersonaSettings settings)
	...
	public static class PersonaSettings {
		...
		public PersonaSettings(String location, String locationAddress, String orientation, String vnetworkProfile,
				String applications) {
			_location = location;
	...
	public static class PersonaDevice {
		...
		public PersonaDevice(String deviceName, String platformName, String platformVersion, String manufacturer,
				String model, String resolution, String network, String location, String description) {
